...
public abstract class F9EditablePostfixTemplate extends PostfixTemplate {
    @NotNull private final TemplateImpl myLiveTemplate;

    public F9EditablePostfixTemplate(@NotNull String templateId,
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof F9EditablePostfixTemplate)) return false;
        if (!super.equals(o)) return false;
        F9EditablePostfixTemplate template = (F9EditablePostfixTemplate)o;
