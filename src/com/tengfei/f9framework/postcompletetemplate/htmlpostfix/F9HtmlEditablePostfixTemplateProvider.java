 ...
 * @author ztf
 */
public class F9HtmlEditablePostfixTemplateProvider implements PostfixTemplateProvider {
    ...
    public PostfixTemplateEditor createEditor(@Nullable PostfixTemplate templateToEdit) {
        if (templateToEdit == null ||
                templateToEdit instanceof F9HtmlEditablePostfixTemplate) {
            F9HtmlEditablePostfixTemplateEditor f9htmlEditablePostfixTemplateEditor = new F9HtmlEditablePostfixTemplateEditor(this);
            f9htmlEditablePostfixTemplateEditor.setTemplate(templateToEdit);
            return f9htmlEditablePostfixTemplateEditor;
        }
        return null;
    }
    ...
    public PostfixTemplate readExternalTemplate(@NotNull String id, @NotNull String name, @NotNull Element template) {
        ...
        return new F9HtmlEditablePostfixTemplate(id, name, "",liveTemplate, this);
    }
    ...
    public void writeExternalTemplate(@NotNull PostfixTemplate template, @NotNull Element parentElement) {
        if (template instanceof F9HtmlEditablePostfixTemplate) {
            ...
            Element templateTag = TemplateSettings.serializeTemplate(((F9HtmlEditablePostfixTemplate) template).getLiveTemplate(), null,
